...
import DynamicTable from './DynamicTable'; // Assuming you have this component
...
const BlogSection: React.FC<BlogSectionProps> = ({
    ...
    return (
        <section id={id} className='md:m-10 lg:m-16 p-4'>
            ...
            {codeExplanation && <p className="mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">{codeExplanation}</p>}
            {tableData && <DynamicTable columns={tableData}/>}
            {tableSummary && <p className="mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400"><strong>Summary:</strong> {tableSummary}</p>}
        </section>
    );
}
